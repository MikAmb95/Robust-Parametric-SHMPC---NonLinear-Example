...
DATA3_w_Param = DATA; stop3_w_P = stop; J3_w_P = J_val; tVec3_P = tVec; nVar3 = nVar;
save('Results/res_w_P_L20','DATA3_w_Param','stop3_w_P','tVec3_P','J3_w_P','nVar3');
